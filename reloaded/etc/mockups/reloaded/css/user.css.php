div.userprofile div.top img.avatar {
...
div.userprofile div.top h1 {
	font-size: 180%;
	font-weight: normal;
	color: #323232;
	margin: 0;
}
div.userprofile div.top h3 {
	margin: 4px 0 0 63px;
	font-size: 90%;
	font-weight: normal;
}
div.userprofile div.top div.tabs div {
	display: block;
	padding: 0 0 0 0;
	float: right;
}
div.userprofile div.top div.tabs {
	clear: both;
	margin: 0 -2px 0 -2px;
...
div.userprofile div.top div.tabs div.tab {
	background-image: url('images/usershadowtab.jpg');
...
div.userprofile div.top div.tabs div.tab a {
	color: #bababa;
}
div.userprofile div.top div.tabs div.leftism {
	background-image: url('images/usershadowtableft.jpg');
	background-repeat: no-repeat;
	background-position: top;
	height: 26px;
	width: 11px;
...
div.userprofile div.top div.tabs div.rightism {
	background-image: url('images/usershadowtabright.jpg');
	background-repeat: no-repeat;
	background-position: top;
	margin-right: 3px;
	height: 26px;
...
div.userprofile div.top div.tabs div.activeright {
	background-image: url('images/usertabright.jpg');
	height: 27px;
}
div.userprofile div.top div.tabs div.activeleft {
	background-image: url('images/usertableft.jpg');
	height: 27px;
}
div.userprofile div.top div.tabs div.active {
	background-image: url('images/usertab.jpg');
}
div.userprofile div.top div.tabs div.active a {
	font-weight: bold;
	color: #1d5087;
}
div.userprofile div.top div.tabs div.tab a:hover {
