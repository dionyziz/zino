<?php
	function ElementArticleView( tInteger $id, tBoolean $oldcomments ) {
		...
		<div class="article"><?php
			Element( 'article/main' , $articleid , $articletitle , $articleicon , $articletext , $articledate , 
									  $articlepageviews , $articleeditors , $articlemodifyuser , $article->CategoryId(), $cicon , $cname , 
									  $commentsnum , $oldcomments );
		?><br />
			<div class="tabs">
			</div>
			<br /><a href="index.php?p=advertise">&#187;Διαφημιστείτε στο Zino</a><br /><br /><?php
