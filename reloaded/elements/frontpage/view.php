<?php
    function ElementFrontpageView() {
        ...
        ?><div id="phoenixrelease" style="text-align: center; width: 750px; margin: 5px; padding: 15px; border: 1px solid black; background-color: #eee;"><img src="http://static.zino.gr/phoenix/info.png" alt="info" />Η ταχύτητα και οι λειτουργίες του Zino ενδέχεται να είναι μειωμένες στις επόμενες 48 ώρες λόγω αναβάθμισης.</div><?php
