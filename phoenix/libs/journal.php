<?php
    ...
    class Journal extends Satori {
        ...
        echo "At the beginning of LoadDefaults: " . ( isset( $this->User ) && is_object( $this->User )? 'yes': 'no' ) . "\n";
            global $user;

            $this->Userid = $user->Id;
            $this->Created = NowDate();
            echo "At the end of OnBeforeCreate: " . ( isset( $this->User ) && is_object( $this->User )? 'yes': 'no' ) . "\n";
        }
        ...
        echo "At the beginning of OnBeforeCreate: " . ( isset( $this->User ) && is_object( $this->User )? 'yes': 'no' ) . "\n";
        ...
        echo "At the beginning of OnCreate: " . ( isset( $this->User ) && is_object( $this->User )? 'yes': 'no' ) . "\n";
            global $libs;
            ...
            echo "At the end of OnCreate: " . ( isset( $this->User ) && is_object( $this->User )? 'yes': 'no' ) . "\n";
        }
        ...
        echo "At the beginning of Relations: " . ( isset( $this->User ) && is_object( $this->User )? 'yes': 'no' ) . "\n";
            $this->User = $this->HasOne( 'User', 'Userid' );
            $this->Bulk = $this->HasOne( 'Bulk', 'Bulkid' );
            echo "At the end of Relations: " . ( isset( $this->User ) && is_object( $this->User )? 'yes': 'no' ) . "\n";
        }
