<?php
    ...
    class Album extends Satori {
        ...
        // if ( $this->mPrint === true ) echo "At thebeginning of Relations: " . ( isset( $this->mRelations[ 'Owner' ] ) && is_object( $this->Owner )? 'yes': 'no' ) . "\n";
            ...
            // if ( $this->mPrint === true ) echo "At theend of Relations: " . ( isset( $this->mRelations[ 'Owner' ] ) && is_object( $this->Owner )? 'yes': 'no' ) . "\n";
        }
        public function IsDeleted() {
            return $this->Delid > 0;
        }
        public function OnBeforeCreate() {
        if ( $this->mPrint === true ) echo "At thebeginning of OnBeforeCreate: " . ( isset( $this->mRelations[ 'Owner' ] ) && is_object( $this->Owner )? 'yes': 'no' ) . "\n";
            ...
            $this->Url = $url;*/
            if ( $this->mPrint === true ) echo "At theend of OnBeforeCreate: " . ( isset( $this->mRelations[ 'Owner' ] ) && is_object( $this->Owner )? 'yes': 'no' ) . "\n";
        }
        ...
        if ( $this->mPrint === true ) echo "At thebeginning of OnCreate: " . ( isset( $this->mRelations[ 'Owner' ] ) && is_object( $this->Owner )? 'yes': 'no' ) . "\n";
            global $libs;
            ...
            $event->Save();
            */
            if ( $this->mPrint === true ) echo "At theend of OnCreate: " . ( isset( $this->mRelations[ 'Owner' ] ) && is_object( $this->Owner )? 'yes': 'no' ) . "\n";
        }
        public function LoadDefaults() {
        if ( $this->mPrint === true ) echo "At thebeginning of LoadDefaults: " . ( isset( $this->mRelations[ 'Owner' ] ) && is_object( $this->Owner )? 'yes': 'no' ) . "\n";
            global $user;
            ...
            $this->Userip = UserIp();
            if ( $this->mPrint === true ) echo "At theend of LoadDefaults: " . ( isset( $this->mRelations[ 'Owner' ] ) && is_object( $this->Owner )? 'yes': 'no' ) . "\n";
        }
    }
