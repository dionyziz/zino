<?php
    ...
    class Album extends Satori {
        ...
        // echo "At the beginning of Relations: " . ( isset( $this->mRelations[ 'Owner' ] ) && $this->mPrint === true && is_object( $this->Owner )? 'yes': 'no' ) . "\n";
            ...
            // echo "At the end of Relations: " . ( isset( $this->mRelations[ 'Owner' ] ) && $this->mPrint === true && is_object( $this->Owner )? 'yes': 'no' ) . "\n";
        }
        public function IsDeleted() {
            return $this->Delid > 0;
        }
        public function OnBeforeCreate() {
        echo "At the beginning of OnBeforeCreate: " . ( isset( $this->mRelations[ 'Owner' ] ) && $this->mPrint === true && is_object( $this->Owner )? 'yes': 'no' ) . "\n";
            ...
            $this->Url = $url;*/
            echo "At the end of OnBeforeCreate: " . ( isset( $this->mRelations[ 'Owner' ] ) && $this->mPrint === true && is_object( $this->Owner )? 'yes': 'no' ) . "\n";
        }
        ...
        echo "At the beginning of OnCreate: " . ( isset( $this->mRelations[ 'Owner' ] ) && $this->mPrint === true && is_object( $this->Owner )? 'yes': 'no' ) . "\n";
            global $libs;
            ...
            $event->Save();
            */
            echo "At the end of OnCreate: " . ( isset( $this->mRelations[ 'Owner' ] ) && $this->mPrint === true && is_object( $this->Owner )? 'yes': 'no' ) . "\n";
        }
        public function LoadDefaults() {
        echo "At the beginning of LoadDefaults: " . ( isset( $this->mRelations[ 'Owner' ] ) && $this->mPrint === true && is_object( $this->Owner )? 'yes': 'no' ) . "\n";
            global $user;
            ...
            $this->Userip = UserIp();
            echo "At the end of LoadDefaults: " . ( isset( $this->mRelations[ 'Owner' ] ) && $this->mPrint === true && is_object( $this->Owner )? 'yes': 'no' ) . "\n";
        }
    }
