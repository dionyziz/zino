    ...
    <div class="tabs">
        <form id="personal" style="display:none" action="">
            ...
            <div>
                ...
                <div class="setting">
                    <select id="gender">
                        <option>Θα απαντήσω αργότερα</option>
                        <option>Αγόρι</option>
...
<script type="text/javascript">// <![CDATA[
    ...
    window.setTimeout( function() { FocusSettingLink( document.getElementById( 'settingslist' ).getElementsByTagName( 'li' )[ 0 ], true); }, 500 );
// ]]></script>
