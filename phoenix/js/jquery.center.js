...
op=jQuery.extend(options,params);return this.each(function(){var $0=jQuery(this);var width=$0.width();var height=$0.height();var paddingTop=parseInt($0.css("padding-top"));var paddingBottom=parseInt($0.css("padding-bottom"));var borderTop=parseInt($0.css("border-top-width"));var borderBottom=parseInt($0.css("border-bottom-width"));var mediaBorder=(borderTop+borderBottom)/2;var mediaPadding=(paddingTop+paddingBottom)/2;var positionType=$0.parent().css("position");var halfWidth=(width/2)*(-1);var halfHeight=((height/2)*(-1))-mediaPadding-mediaBorder;var cssProp={};if($0.css("position")!="fixed"){cssProp.position='absolute';}
