var Comments = {
	...
	Reply : function( nodeid, indent ) {
		...
		var temp = $( "div.newcomment:first" ).clone( true ).css( { margin-left : (indent+1)*20 + 'px', opacity : 0 } ).attr( 'id', 'comment_reply_' + nodeid );
		temp.find( "div.toolbox span.time" ).css( { margin-right : (indent+1)*20 + 'px' } );
