...
$( document ).ready( function() {
	...
	$( 'div.createdfolder' ).droppable( {
		...
		tolerance: "pointer",
		drop : function(ev, ui) {
			alert( 'pmid: ' + ui.draggable.attr( "id" ).substring( 3 ) + '|folderid: ' + $( 'div.sentfolder' ).attr( "id" ).substring( 7 ) + '|targetfolderid: ' + $( this ).attr( "id" ).substring( 7 ) );
			Coala.Warm( 'pm/transfer' , { 'pmid' : ui.draggable.attr( "id" ).substring( 3 ) , 'folderid': $( 'div.sentfolder' ).attr( "id" ).substring( 7 ), 'targetfolderid': $( this ).attr( "id" ).substring( 7 ) } );
