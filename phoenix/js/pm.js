var pms = {
	...
	UpdateUnreadPms : function( specnumber ) {
		...
		var unreadmsgbanner = $( "#unreadmessages" );
		...
		if ( unreadpms > 1 ) {
			...
			//$( unreadmsgbanner ).replaceWith( '<a id="unreadmessages" href="?p=pms" class="messages icon">Μηνύματα</a>' );
			$( unreadmsgbanner ).text( 'Μηνύματα' );
