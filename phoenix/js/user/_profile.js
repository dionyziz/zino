var Profile = {
	...
	AddFriend : function( userid ) {
		...
		$( 'div.usidebar div.basicinfo div a' ).parent().fadeOut( 400 , function() {
			...
			$( this ).parent().parent().css( 'display' , 'none' ).append( document.createTextNode( 'Έγινε προσθήκη' ) ).fadeIn( 400 );
	...
	DeleteFriend : function( relationid ) {
		$( 'div.usidebar div.basicinfo div a' ).parent().fadeOut( 400 , function() {
			$( this ).parent().parent().css( 'display' , 'none' ).append( document.createTextNode( 'Έγινε διαγραφή' ) ).fadeIn( 400 );
		} );
