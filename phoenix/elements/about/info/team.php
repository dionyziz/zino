        ...
        public function Render() {
            ...
            static $team = array(
                ...
                array(
                    ...
                    'about' => array(
                        'Ο Άρης είναι προπτυχιακός φοιτητής στη σχολή Ηλετρολόγων Μηχανικών στο Αριστοτέλειο
                        Πανεπιστήμιο Θεσσαλονίκης.',
                        
                        'Στο παρελθόν έχει εργαστεί ως μηχανικός λογισμικού στο BlogCube. Είναι μέλος
                        της Kamibu από την ίδρυσή της. Δε χάνει ευκαιρία για clubbing με τους φίλους του.',
                        
                       'Λατρεύει το ανοιχτό λογισμικό και την trance.'
                    )
                ),
                array(
                    'nickname' => 'd3nnn1z',
                ...
                array(
                    ...
                    'about' => array(
                        ...
                        'Σήμερα εργάζεται για την Black Box Studios και για την Kamibu παράλληλα ως 
                        software developer. Πιστεύει ότι είναι ψάρι.',
                ...
                array(
                    ...
                    'about' => array(
                        ...
                        'Είναι στην Kamibu από τον Μάρτιο του 2007. Συνήθως νιαουρίζει -καμιά φορά διορθώνει bugs και ακόμα
						πιο σπάνια γράφει κάποιο νέο χαρακτηριστικό.',
                        
                        'Λατρεύει τις γυναίκες, να πειραματίζεται με ανοιχτό λογισμικό και δίκτυα, να γράφει κώδικα. Και να πίνει μπύρες.'
                    )
                ),
            );
                ...
                <div id="aboutperson">
                    <div class="aboutoneperson" id="iamnoone">
                        ...
                        <p>
                            ...
                            μέλος της ομάδας μας εκτός από την δουλειά του στο Zino έχει και πολλά
                            άλλα ενδιαφέροντα για τα οποία αξίζει να μας γνωρίσεις.
                        </p>
                        <p>
                            Για να μας γνωρίσεις διάλεξε μία από τις φάτσες που σου αρέσει. Μη 
                            διστάσεις να επισκεφθείς το προφίλ του καθενός και να μας αφήσεις ένα
                            ενθαρρυντικό σχόλιο — αυτά είναι που μας κάνουν να έχουμε πάθος και αγάπη
                            για τη δουλειά μας. Θα χαρούμε πολύ να μας προσθέσεις στους φίλους 
