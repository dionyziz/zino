        ...
        public function Render() { 
            ...
            <div class="create status">
                ...
                <div class="right">
                    ...
                    <strong>Για να ολοκληρωθεί η συναλλαγή σας, παρακαλούμε πραγματοποιήστε κατάθεση
                    με τα εξής στοιχεία:</strong><br />
                    ...
                    <strong>Στη συνέχεια αποστείλετέ μας την απόδειξη κατάθεσης μέσω e-mail στο 
                    <a href="mailto:ads@zino.gr">ads@zino.gr</a></strong></p>
