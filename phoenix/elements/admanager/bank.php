        ...
        public function Render() { 
            ...
            <div class="create status">
                ...
                <div class="right">
                    ...
                    <strong>Για να ολοκληρωθεί η συναλλαγή σας, παρακαλούμε πραγματοποιήστε την 
                    τραπεζική κατάθεση:</strong><br />
                    ...
                    <strong>Αποστείλτε μας την απόδειξη κατάθεσης μέσω e-mail στο 
