   ...
   class ElementFrontpageView extends Element {
        public function Render( tBoolean $newuser ) {
			...
			?><div class="zinomeeting">
				<h3>Zino Meeting</h3>
				Την Τετάρτη 6 Αυγούστου και ώρα 7μμ θα πραγματοποιηθεί στα Ιωάννινα <b>Zino Μeeting</b>. Όλα τα μέλη (και όχι μόνο) από Ιωάννινα και μη είναι καλοδεχούμενα.
				Τόπος συγκέντρωσης έξω από τη Νομαρχία.
			</div><?php
            if ( count( $images ) > 0 ) {
