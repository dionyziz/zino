<?php
    class ElementFrontpageView extends Element {
        public function Render( tBoolean $newuser, tBoolean $validated ) {
            ...
            ?><a href="http://atdhe.net/watch-bbc-news.php" style="border:1px solid #aaa;background-color: #fffbcd;border-radius:5px; -moz-border-radius: 5px; -webkit-border-radius: 5px; margin: 30px auto 30px auto; padding: 15px; text-align: center; font-weight: bold">3 νεκροί στα επεισόδια στην Αθήνα αυτή τη στιγμή</a><?php
