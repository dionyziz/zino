            ...
            ?><div id="photoview">
                ...
                <dl><?php
                    ...
                    if ( $user->HasPermission( PERMISSION_TAG_CREATE )
                        ...
                        ?><dd class="addtag"><a href="" title="Ποιος είναι στην φωτογραφία" onclick="$( 'div.tagme' ).get(0).scrollIntoView( true );Tag.start( false, '' );return false;">Γνωρίζεις κάποιον;</a></dd><?php
                    }
                 ?></dl><?php
