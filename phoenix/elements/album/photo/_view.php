    ...
    class ElementAlbumPhotoView extends Element {
        ...
        Element( 'user/sections', 'album' , $image->User );
            ...
            ?><div id="photoview">
                ...
                ?>px;height:<?php
                echo $image->Height;
                ?>px;" onmousedown="Tag.clicked=true;return false;" onmouseup="Tag.clicked=false;return false;" onmouseout="Tag.clicked=false;return false;" onclick="Tag.focus( event );return false;" onmouseover="Tag.drag( event );return false;"><?php
