    ...
    class ElementAlbumPhotoView extends Element {
        ...
        Element( 'user/sections', 'album' , $image->User );
            ...
            ?><div id="photoview">
                ...
                ?>px;height:<?php
                echo $image->Height;
                ?>px;" onmousedown="alert( 'mousedown' );Tag.clicked=true;Tag.focus( event );return false;" onmouseup="alert( 'mouseup' );Tag.clicked=false;return false;" onmouseout="ekso( event );return false;" onmousemove="Tag.drag( event );return false;"><?php
