    ...
    class ElementAlbumPhotoView extends Element {
        public function Render( tInteger $id , tInteger $commentid , tInteger $pageno ) {
            ...
            ?><div id="photoview">
                ...
                ?>px;height:<?php
                echo $image->Height;
                ?>px;" onmousedown="Tag.katoPontike( event );return false;" onmouseup="Tag.showSug( event );return false;" onmouseout="Tag.ekso( event );$( 'div.messageboxer' ).get( 0 ).innerHTML += '<br />Tag.clicked = false apo tomegalo ekso';return false;" onmousemove="Tag.drag( event );return false;"><?php
