<?php
    ...
    class ElementBanner extends Element {
        public function Render() {
            ...
            <div style="position:absolute;right:105px;top:0;z-index:10;width:120px;height:74px;background-image:url('http://static.zino.gr/phoenix/xmas4.png');background-position:right;background-repeat: no-repeat;">&nbsp;</div>
            <h1><a href="<?php
