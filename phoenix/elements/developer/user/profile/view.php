<?php
    class ElementDeveloperUserProfileView extends Element {
        public function Render( tText $name , tText $subdomain, tInteger $commentid , tInteger $pageno ) {
            ...
            if ( !isset( $theuser ) || $theuser === false ) {
                return Element( 'developer/404', 'Ο χρήστης δεν υπάρχει' );
            }
            ...
            if ( $theuser->LastActivity->Updated != '0000-00-00 00:00:00' ) {
                if ( $theuser->LastActivity->IsOnline() ) {
                    ...
                    ob_start();
                    Element( 'developer/date/diff' , $theuser->LastActivity->Updated );
                    $text = ob_get_clean();
                }
            ...
            ?><div id="profile"><?php
                ...
                Element( 'developer/user/profile/sidebar/view' , $theuser , $theuser->Id , $theuser->Profile->Updated, $schoolexists );
                $e = Element( 'developer/user/profile/main/view' , $theuser, $commentid, $pageno );
