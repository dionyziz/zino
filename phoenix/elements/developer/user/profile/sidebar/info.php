<?php
    class ElementDeveloperUserProfileSidebarInfo extends Element {
            ...
            ?><div class="info">
                <dl><?php
					...
					if ( $theuser->Profile->Schoolid > 0 && $theuser->Profile->Placeid > 0 ) {
						...
						Element( 'developer/user/trivial/school', $theuser->Profile->School );
                        if ( $schoolexists ) {
                            ?></a><?php
                        }
						?></dd><?php
                    ...
                    if ( $theuser->Profile->Haircolor != '-' ) {
                        ...
                        <dd><?php
                        Element( 'developer/user/trivial/haircolor' , $theuser->Profile->Haircolor );
                        ?></dd><?php
                    }
                    if ( $theuser->Profile->Eyecolor != '-' ) {
                        ?><dt><strong>Χρώμα ματιών</strong></dt>
                        <dd><?php
                        Element( 'developer/user/trivial/eyecolor' , $theuser->Profile->Eyecolor );
                        ?></dd><?php
                    }
                ?></dl>
            </div><?php
