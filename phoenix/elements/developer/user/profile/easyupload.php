<?php
    class ElementDeveloperUserProfileEasyupload extends Element {
        public function Render () {
            ...
            ?><div>
                ...
                echo $album->Id;
                ?>" class="selected"><?php
                Element( 'developer/image/view' , $album->Mainimageid , $album->Mainimage->Userid , 100 , 100 , IMAGE_CROPPED_100x100 , '' , "Eγώ" , false , true , 50 , 50 , 0 );
                ?></li><?php
                foreach ( $albums as $album ) {
                    if ( $album->Id != $user->Egoalbumid ) {
                        ...
                        echo $album->Id;
                        ?>"><?php
                        Element( 'developer/image/view' , $album->Mainimageid , $album->Mainimage->Userid , 100 , 100 , IMAGE_CROPPED_100x100 , '' , $album->Name , false , true , 50 , 50 , 0 ); ?></li><?php
                    }
                }
                ?></ul></div>
            </div>
