<?php
    class ElementDeveloperUserRelationsRow extends Element {
        public function Render( $friendarray, $isfriend ) {
            ...
            ?><li id="user_<?php
                ...
                ?><a href="<?php
                ob_start();
                Element( 'developer/user/url', $friendarray[ 'user_id' ], $friendarray[ 'user_subdomain' ] );
                echo htmlspecialchars( ob_get_clean() );
                ?>"><?php
                Element( 'developer/user/avatar' , $friendarray[ 'user_avatarid' ], $friendarray[ 'user_id' ], 100, 100, $friendarray[ 'user_name' ], 100 , 'avatar' , '' , true , 50 , 50 );
                Element( 'developer/user/name' , $friendarray[ 'user_id' ], $friendarray[ 'user_name' ], $friendarray[ 'user_subdomain' ], false );
                ?></a><?php
                ?></div>
                <?php
                ...
                ?><span class="lastactive"><?php
                    ...
                    Element( 'developer/date/diff', $friendarray[ 'lastactive_updated' ] );
                ?></span>
                <div class="barfade">
