<?php
    ...
    class ElementDeveloperUserSettingsPersonalAvatar extends Element {
        public function Render() {
            ...
            Element( 'developer/user/avatar' , $user->Avatarid , $user->Id , $user->Avatar->Width , $user->Avatar->Height , $user->Name , 150 , 'avie' , '' , false , 0 , 0 );
            ...
            <div id="avatarlist">
                ...
                if ( $egoalbum->Numphotos > 0 ) {
                    ...
                    foreach ( $images as $image ) {    
                        ?><li><?php
                        Element( 'developer/user/settings/personal/photosmall' , $image );
                        ?></li><?php
                    }
                }
                ?></ul>
