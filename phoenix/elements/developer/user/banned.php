<?php
    class ElementDeveloperUserBanned extends Element {
        public function Render() {
            ...
            ?><div style="margin:10px auto 0 auto;padding:10px;width:70%">
                ...
                <div style="margin-left:170px">
                    ...
                    echo htmlspecialchars( $rabbit_settings[ 'applicationname' ] );
                    ?>, αυτός ο λογαριασμός έχει τεθεί εκτός λειτουργίας επ' αορίστου. Εάν χρησιμοποιείς οποιοδήποτε λογισμικό τρίτων που αλληλεπιδρά με τον λογαριασμό σου στο <?php 
                    echo htmlspecialchars( $rabbit_settings[ 'applicationname' ] );
