<?php
    ...
    class ElementDeveloperUserSections extends Element {
        public function Render( $section , $theuser ) {
            ...
            ?><div class="sx_0009 usersections">
                ...
                <a href="<?php
                    Element( 'developer/user/url' , $theuser->Id , $theuser->Subdomain );
                    ?>"><?php
                    Element( 'developer/user/avatar' , $theuser->Avatarid , $theuser->Id , $theuser->Avatar->Width , $theuser->Avatar->Height , $theuser->Name , 150 , '' , '' , false , 0 , 0 );
                    ?><span class="name"><?php
                    echo $theuser->Name;
                    ?></span>
                </a>
