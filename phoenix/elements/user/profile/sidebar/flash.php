<?php
	class ElementUserProfileSidebarFlash extends Element{
		public function Render( $widgetid ){
			...
			if( $widgetid != -1 ){
				?><div class="player"><object><param name="movie" value="http://listen.grooveshark.com/songWidget.swf"></param><param name="wmode" value="opaque"></param><param name="allowScriptAccess" value="always"></param><param name="flashvars" value="hostname=cowbell.grooveshark.com&#38;widgetID=<?php
							echo $widgetid;
