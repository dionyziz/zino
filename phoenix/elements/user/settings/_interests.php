            ...
            ?><div class="option">
                ...
                <div class="setting">
                    ...
                    <div class="add hobbies">
                        <input type="text" onclick="$( 'div.hobbies ul' ).show();" onkeyup="Suggest.inputMove( event, 'hobbies' );" onblur="$( 'div.hobbies ul' ).hide();alert( $( 'div.' + type + ' ul' ).get( 0 ).clientWidth + ' ' + $( 'div.' + type + ' ul' ).get( 0 ).offsetWidth );" onfocus="$( 'div.hobbies ul').show();"/>
