    ...
    function ElementWYSIWYGControls() {
        ?><div class="wysiwyg-control" id="wysiwyg-controls">
            ...
            <form class="wysiwyg-control-image-start">
                <br /><br />
                <ul>
                    <li><a href="" onclick="Modals.Destroy();Modals.Create($('#wysiwyg-controls form.wysiwyg-control-image-url').cloneNode());return false;">Εισαγωγή εικόνας με την διεύθυνσή της</a></li>
