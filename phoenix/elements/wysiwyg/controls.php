    ...
    function ElementWYSIWYGControls() {
        ?><div class="wysiwyg-control" id="wysiwyg-controls">
            ...
            <form class="wysiwyg-control-image-start">
                <br /><br />
                <ul>
                    <li><a href="" onclick="Modals.Destroy();alert($(this.parentNode.parentNode.parentNode.parentNode)[0].className);return false;">Εισαγωγή εικόνας με την διεύθυνσή της</a></li>
