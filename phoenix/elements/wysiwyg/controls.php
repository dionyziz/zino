    ...
    function ElementWYSIWYGControls() {
        ?><div class="wysiwyg-control" id="wysiwyg-controls">
            ...
            <form class="wysiwyg-control-image-start">
                <br /><br />
                <ul>
                    <li><a href="" onclick="Modals.Destroy();alert($($(this).parents('div')[0]).find('form.wysiwyg-control-image-url')[0]);return false;">Εισαγωγή εικόνας με την διεύθυνσή της</a></li>
