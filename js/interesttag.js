		...
		close.onclick = ( function( ul ) {
				return function() {
					if ( InterestTag.onedit ) {
						Modals.Confirm( "Βρίσκετε κατά την μέση μιας επεξεργασίας.Είστε σίγουροι ότι θέλετε να κλείσετε το παράθυρο;", InterestTag.Closing( ul ) );
						return false;
					}
