<?php
	function ElementAdvertiseInfo() {
		...
		?><br /><br /><div class="body">
			...
			Στο chit-chat υπάρχει δυνατότητα να διαφημιστείτε σε τέσσερα διαφορετικά σημεία με banners διαστάσεων 370x80. Τα σημεία που μπορούν να
			...
			των banners σας σε σχέση με τα άλλα που εμφανίζονται ταυτόχρονα είναι 50%.<br />
			Τιμές
			<ul>
