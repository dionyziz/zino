<?php
	function ElementAdvertiseInfo() {
		...
		?><br /><br /><div class="body" id="body">
			...
			το chit-chat ιδανική περίπτωση για την προβολή της εταιρείας σας. Το chit-chat είναι μία προσπάθεια που γίνεται 
            αφιλοκερδώς και συντονίζεται από φοιτητικές και μαθητικές ομάδες, και χρησιμοποιεί πρωτόγνωρες για την Ελλάδα τεχνολογικές
