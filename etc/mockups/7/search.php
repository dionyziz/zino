    ...
    <div class="criteria">
        ...
        Ψάχνω για φίλους...<br />
            ...
            <div class="location search">
                ...
                <input type="radio" name="locationpick" id="location_dontcare" selected="selected" /><label for="location_dontcare">Όλες οι περιοχές</label>
                <input type="radio" name="locationpick" id="location_specify" selected="selected" /><label for="location_specify">Μόνο από συγκεκριμένες περιοχές</label>
