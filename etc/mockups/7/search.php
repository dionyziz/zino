    ...
    <div class="criteria">
        ...
        Ψάχνω για φίλους...<br />
            <div>
                <h3>Φύλο</h3>
                <input type="radio" value="male" id="gender_male" /><label for="gender_male">Αγόρια μόνο</label>
                <input type="radio" value="female" id="gender_female" /><label for="gender_female">Κοπέλες μόνο</label>
                <input type="radio" value="male" id="gender_both" selected="selected" /><label for="gender_both">Και τα δύο</label>
            </div>
            
            <div>
                <h3>Ηλικία</h3>
                <input type="radio" id="age_dontcare" selected="selected" /><label for="gender_dontcare">Όλες οι ηλικίες</label>
                <input type="radio" id="age_specify" selected="selected" /><label for="gender_specify">Συγκεκριμένες ηλικίες μόνο</label>
                από: 
                <select>
            ...
            <div>
                ...
                <input type="radio" id="location_dontcare" selected="selected" /><label for="location_dontcare">Όλες οι περιοχές</label>
                <input type="radio" id="location_specify" selected="selected" /><label for="location_specify">Μόνο από συγκεκριμένες περιοχές</label>
