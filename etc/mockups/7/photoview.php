...
?><div class="photoview">
	...
	<div style="overflow:hidden;">
		<ul>
			<li class="nav"><a href=""><img src="images/previous.png" alt="Προηγούμενη" title="Προηγούμενη" /></a></li>
			...
			<li class="nav"><a href=""><img src="images/next.png" alt="Επόμενη" title="Επόμενη" /></a></li>
		</ul>
	</div>
	<div class="eof"></div>
	<div class="thephoto">
